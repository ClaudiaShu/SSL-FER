...
from data_aug.data_loader import maskCLR
from models.resnet_simclr import ResNetSimCLR, ResNetEncoder
from trainer_maskclr import MaskCLR
...
def main():
    ...
    transforms_crop = dataset.get_crop_transform()
    ...
    train_dataset = maskCLR(args=args,
